(() => {
    ...
    function initSliders() {
        if (document.querySelector(".restaurants__slider")) {
            new swiper_core_Swiper(".restaurants__slider-top", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.8,
            ...
            new swiper_core_Swiper(".restaurants__slider-bottom", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.8,
        ...
        if (document.querySelector(".collaboration__slider")) new swiper_core_Swiper(".collaboration__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 6,
            ...
            speed: 800,
            navigation: {
                prevEl: ".collaboration__slide-prev",
                nextEl: ".collaboration__slide-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 3,
